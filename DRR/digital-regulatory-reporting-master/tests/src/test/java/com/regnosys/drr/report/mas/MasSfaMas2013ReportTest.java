...
public class MasSfaMas2013ReportTest {

    @RegisterExtension
    static TransformTestExtension<MASSFAMAS_2013ReportFunction> testExtension =
            new TransformTestExtension<>(
                    new ReportTestRuntimeModule(),
                    REPORT_CONFIG_PATH,
                    MASSFAMAS_2013ReportFunction.class);
    ...
    void runReport(String testName,
                   ...
                   MASSFAMAS_2013ReportFunction func) {
